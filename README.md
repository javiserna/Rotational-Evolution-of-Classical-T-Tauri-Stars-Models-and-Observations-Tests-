...
### Case A (Model: Magnetic field decreases with age)
...
### (Model: Magnetic field increases with age)
...
### (Model: Magnetic field remains constant with age)
...
Test 1 demonstrates that distributions of vsin(i) observed and predicted by the Back-forward test tend to be similar above 80%. While similarity provided by the model of the magnetic field increases with age and the magnetic field constant, decreases with age and tends to be below 50%.
...
### Case B (Model: Branching ratio decreases with age)
...
### (Model: Branching ratio increases with age)
...
### (Model: Branching ratio remains constant with age)
...
Case B demonstrates that distributions of vsin(i) observed and predicted by the back-forward test tend to be similar above 80%. While similarity provided by Tests 2 and 3 decreases with age and tends to be below 50%.
...
### (Model: Magnetic field and Branching ratio simultaneously decreases with age)
We feed our models with values of the Magnetic field and Branching ratio that follow the CDF of each bin (Figure 13). Also, we use identical values as employed in the ABC procedure (section 3.5.1) of the mass accretion rate per bin from Figure 11, and the initial rotation period within the range of 1 to 8 days.

In the subsequent plots, we illustrate the resulting distributions of vsin(i) generated by our models in comparison to our observational data. 

<img src="https://github.com/javiserna/Rotational-Evolution-of-Classical-T-Tauri-Stars-Models-and-Observations-Tests-/blob/main/Figures/bin1_vsini_posterior_combined.png?raw=true" width="400"/> <img src="https://github.com/javiserna/Rotational-Evolution-of-Classical-T-Tauri-Stars-Models-and-Observations-Tests-/blob/main/Figures/bin2_vsini_posterior_combined.png?raw=true" width="400"/>
...
<img src="https://github.com/javiserna/Rotational-Evolution-of-Classical-T-Tauri-Stars-Models-and-Observations-Tests-/blob/main/Figures/Similarity_combined.png?raw=true" width="800"/>
