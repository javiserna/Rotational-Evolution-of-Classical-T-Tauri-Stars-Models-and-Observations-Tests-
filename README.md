...
The vsini histograms are properly normalized to the area of distributions and the error bars in the model distribution represent the standard deviation of 100 realizations.
