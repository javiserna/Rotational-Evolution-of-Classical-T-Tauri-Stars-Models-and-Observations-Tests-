...
Here, we prove that the decrease of magnetic field and branching ratio distributions with age (Figure 12 of our paper) is the best scenario to effectively account for v sin(i) observations of Figure 10. This is evidence that our ABC model results are auto-consistent with observations.
