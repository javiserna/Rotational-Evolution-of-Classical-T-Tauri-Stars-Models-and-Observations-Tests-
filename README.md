...
We build a sequence of distributions of magnetic field increasing along the bins and use similar conditions to test 1 for mass accretion rate, initial period, and branching ratio. In the subsequent plots, we illustrate the resulting distributions of vsin(i) generated by our models in comparison to our observational data.
