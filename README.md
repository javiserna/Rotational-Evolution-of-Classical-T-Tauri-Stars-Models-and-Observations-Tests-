...
We choose values of the magnetic field that follow the CDF of each bin (Figure 13). Also, we use values of the mass accretion rate per bin from Figure 11, choose random values of the initial rotation period within the range of 1 to 8 days, and set the branching ratio parameter to 0.3.
...
We build a set of Gaussian distributions of magnetic field increasing along the age and use similar conditions for mass accretion rate, initial period, and branching ratio as the Test 1. 
...
We construct a Gaussian distribution of magnetic field with a fixed value of 2500 G in all age bins and use similar conditions for mass accretion rate, initial period, and branching ratio as the Test 1. 
...
Test 1 demonstrates that distributions of vsin(i) observed and predicted by the ABC method tend to be similar above 80%. While similarity provided by Tests 2 and 3 decreases with age and tends to be below 40%.
...
We choose values of the Branching ratio that follow the CDF of each bin (Figure 13). Also, we use values of the mass accretion rate per bin from Figure 11, choose random values of the initial rotation period within the range of 1 to 8 days, and set the magnetic field parameter to 2000 G.
...
We construct a Gaussian distribution of branching ratio with a fixed value of 0.5 in all age bins and use similar conditions for mass accretion rate, initial period, and magnetic field than Test 1. 
